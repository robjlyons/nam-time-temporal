...
class TemporalTrainingConfig:
    ...
    alignment_mode: str = "global"  # none|global|piecewise
    piecewise_block_samples: int = 65536
    piecewise_hop_samples: Optional[int] = None
    piecewise_smooth_blocks: int = 3
    piecewise_max_residual_delay_samples: int = 512
    piecewise_min_peak_ratio: float = 1.02
    normalization_mode: str = "none"  # none|rms_match|affine
